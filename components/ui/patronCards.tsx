...
export function PatronCards() {
  return (
       <div className="flex items-center gap-2 justify-center pt-16 flex-wrap">
                  <Card>
      <CardTitle>Hüseyin Onur</CardTitle>
      <CardDescription>
       <p className="text-lg font-semibold">Görev: Web Yöneticisi</p>
        <p className="text-lg font-semibold">Telefon Numarası: 0543 371 7431</p>
      </CardDescription>
    </Card>
        <Card>
        <CardTitle>Talha Elevli</CardTitle>
        <CardDescription>
         <p className="text-lg font-semibold">Görev: Makina Ressamı</p>
          <p className="text-lg font-semibold">Telefon Numarası: 0555 011 6914</p>
        </CardDescription>
      </Card>
       </div>
  );
